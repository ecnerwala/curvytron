...
Game.prototype.isWon = function()
{
    ...
    var maxScore = this.maxScore,
        players = this.avatars.filter(function () { return this.present && this.scorekeeper.score >= maxScore; });
    ...
    return players.items[0].scorekeeper.score === players.items[1].scorekeeper.score ? null : players.getFirst();
};
